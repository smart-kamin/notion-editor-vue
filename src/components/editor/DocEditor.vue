...
:deep(.doc-editor__content) {
  ...
  /* Слева место для панели [+][⠿], справа столько же — ради симметрии полей.
     Поля ОДИНАКОВЫ в правке и в просмотре, хотя панели в просмотре нет: иначе
     при переключении режима весь текст прыгает по горизонтали, а страница,
     собранная из просмотра и правки одного документа, показывает его в двух
     разных сетках. Пустое поле слева дешевле этого прыжка. */
  padding-inline: 4rem;
}
